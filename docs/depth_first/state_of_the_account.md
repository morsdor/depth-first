...
| **r006** | I17 | Flight path isn't curved, the map is | 32 s | 09-08 | **80,000+** (46,782 at day 1) | 916 at day 1 | 303 | 362 | **~120** (71 at day 1) | 09-10 |
| r007 | I22 | Your message goes underwater | 28 s | 09-09 | ~1,800 peak | — | — | — | — | 09-10 |
| r009 | I58 | Sun pulls 179× harder, Moon makes the tide | 54 s | 09-10 | 189 | 4 | — | — | 1 | 09-10 |
| r010 | I69 | Fifteen pendulums come back at 30 s | 34 s | 09-10 | 190 | 0 | 0 | 0 | 0 | 09-10 |

**Followers: 145.** Built and not posted: r005 shuffle (`I51`, 39 s, five rebuilds), r008 A\* (`I15`,
...
**2. Reach and follows are two separate problems.** r006 converted 0.216% of its day-1 viewers into
...
(422), r009 (189) and r010 (190) are what "shown to followers plus a small cold sample that did not
engage" looks like. The ranking system either keeps feeding a reel in its first hours or it stops.
r007 at ~1,800 got some cold distribution; the floor reels got essentially none.
...
- r009's Gate 0 record says: *"nobody is arguing about tidal bulges, so the reach test's 'a dispute
  is already running' is unmet."*
- r010's Gate 0 record says: *"almost nobody has stood in front of a pendulum wave; they have only
...
views after its first day. r009 and r010 were read on the day they were posted, so they are
...
|:--|:--|
| Motion / event density | r007 scored 46% and did ~1.8k; r006 scored 38% and did 80k; r010 scored 99% and did 190 |
| Length | the floor holds 28 s, 37 s, 43 s and 54 s reels alike |
| Section / accent colour | floor and hit are both §2 maps |
| Rendering craft, rigor, per-beat audits | five rebuilds of r005 raised rigor and lowered watchability every time |

**7. Things that have, each on a single data point:**

| Lever | Evidence | n |
|:--|:--|--:|
| An argument already running, evidence personally witnessed, one repeatable number | r006 (flat-earth exhibit) vs r007 (built to the same pattern minus the argument): 80k vs 1.8k | 1 vs 1 |
...
- **Did r006's ~120 followers watch r009 and r010?** Insights shows follower vs non-follower share
...
- **Retention curves for r007, r009, r010.** Only r001–r004 and r006 have theirs recorded.
