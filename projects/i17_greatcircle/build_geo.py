...
Emits remotion/src/reels/data/i17_geo.ts. The projection maths itself lives in
...
Run:  .geoenv/bin/python projects/i17_greatcircle/build_geo.py
"""
import json
import math
import textwrap
...
OUT = Path("remotion/src/reels/data/i17_geo.ts")
...
body = f"""\
// GENERATED by projects/i17_greatcircle/build_geo.py — do not edit by hand.
//
