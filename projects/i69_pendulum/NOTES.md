...
```bash
python3 projects/i69_pendulum/simulate.py
python3 projects/i69_pendulum/emit_ts.py
MANIM_W=1350 MANIM_H=2400 python3 scripts/manim_render.py \
    projects/i69_pendulum/scene_pendulum.py Pendulums i69pendulum
python3 projects/i69_pendulum/check_annotations.py
cd remotion && npx remotion render r010-pendulum \
    ../projects/i69_pendulum/r010_pendulum.mp4 --codec=h264
```
