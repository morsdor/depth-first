# r009 · `I58` — "The Sun pulls the Earth 179x harder than the Moon. The Moon makes the tide."
...
is the one beat that lands inside an argument people actually have. **If r009 underperforms, that is
