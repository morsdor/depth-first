...
Pendulum.tsx       → r008-pendulum / r008-pendulum-safe
```

The 1020 PNGs are **155 MB and gitignored** (`.gitignore:55`), so a clean checkout has to
regenerate them before `r008-pendulum` will render:

```bash
python3 projects/r008_pendulum/simulate.py
python3 projects/r008_pendulum/emit_ts.py
MANIM_W=1350 MANIM_H=2400 python3 scripts/manim_render.py \
    projects/r008_pendulum/scene_pendulum.py Pendulums i69pendulum
python3 projects/r008_pendulum/check_annotations.py
cd remotion && npx remotion render r008-pendulum \
    ../projects/r008_pendulum/r008_pendulum.mp4 --codec=h264
```
...
I51 v5 53%, r005 38%, r006 46%, I15 54%, r007 (tides) 47%, and the shelved `I64` queue build 65%.
