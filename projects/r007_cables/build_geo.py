...
Emits remotion/src/reels/data/r007_geo.ts. Run it, don't hand-edit the output.
...
── Where every number comes from ───────────────────────────────────────────
  ...
  * Coastlines     — GSHHG low-resolution rings, re-emitted from r006's
                     generated r006_geo.ts and re-wrapped from its mid-Atlantic
                     seam to a Pacific one. This route crosses the Atlantic, so
                     r006's seam would cut it in half.
...
OUT = ROOT / "remotion/src/reels/data/r007_geo.ts"
...
# ── coastlines ──────────────────────────────────────────────────────────────
def coastlines():
    """GSHHG rings from r006's generated module, re-wrapped to a Pacific seam
    ...
    keeps the two map reels pixel-consistent. If r006_geo.ts is ever regenerated
    at a different simplification, regenerate this too.
    """
    src = (ROOT / "remotion/src/reels/data/r006_geo.ts").read_text()
...
ts = f'''// GENERATED by projects/r007_cables/build_geo.py — do not edit by hand.
//
// r007 / I22 — "Your message to a friend abroad goes underwater."
//
