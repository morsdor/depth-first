#!/usr/bin/env python3
"""r005 / I17 — compute the geometry, don't author it.
...
Emits remotion/src/reels/data/r005_geo.ts. The projection maths itself lives in
...
Run:  .geoenv/bin/python projects/r005_greatcircle/build_geo.py
"""
import json
import math
import textwrap
...
OUT = Path("remotion/src/reels/data/r005_geo.ts")
...
body = f"""\
// GENERATED by projects/r005_greatcircle/build_geo.py — do not edit by hand.
//
// r005 / I17 — "Your flight path isn't curved. Your map is."
//
