# r005 (I17) — what is claimed, and what it cost
...
```
r005_greatcircle.mp4  32.5s  (130 samples @ 4fps)
  median change      0.608
...
38% against r004's 42% and I51 v5's 53%. It clears the 26% level a viewer called static, and it gets
...
`reel_captions_log.md` → r005 → load-bearing phrasings.
