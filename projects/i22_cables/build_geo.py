...
Emits remotion/src/reels/data/i22_geo.ts. Run it, don't hand-edit the output.
...
── Where every number comes from ───────────────────────────────────────────
  ...
  * Coastlines     — GSHHG low-resolution rings, re-emitted from r006's
                     generated i17_geo.ts and re-wrapped from its mid-Atlantic
...
OUT = ROOT / "remotion/src/reels/data/i22_geo.ts"
...
def coastlines():
    ...
    keeps the two map reels pixel-consistent. If i17_geo.ts is ever regenerated
...
ts = f'''// GENERATED by projects/i22_cables/build_geo.py — do not edit by hand.
//
// r007 / I22 — "Your message to a friend abroad goes underwater."
//
