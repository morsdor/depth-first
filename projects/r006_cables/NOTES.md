...
28 s. Built 2026-09-09. Second reel through Gate 0, and the test of the r005
...
reel **ends on an arrival** — the one structural thing carried over from r005
unchanged, because r005's last frame was an arrival and was its most-liked frame.

## What r005's day-1 numbers changed

- **28 s, not 32.** Instagram's like-timing histogram put r005's tallest bar on
  ...
  after it.
- **A second surprise at 14.4 s.** r005's retention was a linear bleed with no
...
- **A performable end-card ask**, in the shape that worked on r005 ("open a
  ...
  reel: r005's end card promised this one, and `I15`'s promise was broken.

## Gate numbers

```
r006_cables.mp4  28.5s  (114 samples @ 4fps)
  median change      0.956
...
below I51's first cut at 26%, which a viewer called static. Flowing dashes took
...
scored lowest of any beat. r005 cleared the bar because a globe↔map morph moves
...
benchmark in `CLAUDE.md` (r004 42%, I51 v5 53%, r005 38%) is at 240.
...
screen at all. r005 had this right and its header is the model: **"Your flight
...
- **Cable geometry must be welded before it is measured.** Trimming a single
  ...
  a graph and walked.
- **The seam is at 180°, not r005's −30°.** This route crosses the Atlantic, so
  r005's mid-Atlantic seam would cut it in half. Coastline rings are re-wrapped
