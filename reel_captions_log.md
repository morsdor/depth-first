...
| `r006` | 2026-09-08 | A (below) | "Those curved flight paths on the seatback map are the straight lines. The map is bent, not the flight." | 100 | 5 | 36 | 8 | **Figures at ~4 h, still climbing — backfill at 3 days.** 6,799 viewers, 4x the account's previous best. Average watch held at 16 s of 32 s (50%) across a 13x audience expansion, which is the real result. Best save rate (0.53%) and follow rate (0.118%) on the account; shares (0.07%) remain 6x worse than r001 and unexplained. **The 1 h reading that saves were structurally weak was wrong and is retracted** — see `brand_guide_software.md` §13. |
