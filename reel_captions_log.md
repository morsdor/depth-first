...
| `r006` | 2026-09-08 | A (below) | "Those curved flight paths on the seatback map are the straight lines. The map is bent, not the flight." | 211 | 73 | 86 | 16 | **Figures at ~7 h, still climbing — backfill at 3 days.** 10,311 viewers, 6.4x the account's previous best, and best-in-class on every per-viewer metric: likes 2.05%, shares 0.71%, saves 0.83%, follows 0.155%. Average watch rose 16 s -> 17 s of 32 s (53%) while the audience grew 20x, which is the real result. **Two conclusions written from early readings were retracted** — saves at 1 h and shares at 4 h were both unpopulated counts, not low rates. See `brand_guide_software.md` §13. |
