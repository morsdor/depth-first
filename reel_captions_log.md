...
| `r007` | 2026-09-10 | A (below) — confirm which caption went out | "The Sun pulls on the Earth 179 times harder than the Moon does. The Moon still makes the tide." | 4 | — | — | 1 | **~600 views at 2026-09-11**, up from 189 at first reading — the lowest of the nine. On the account's floor. First reel outside software and the longest at 54 s. Gate 0 recorded its weak leg in advance: nobody is arguing about tidal bulges, so the reach test's "a dispute is already running" is unmet and the body comparison carries that load in the last beat. |
| `r005` | 2026-09-08 | A (below) | "Those curved flight paths on the seatback map are the straight lines. The map is bent, not the flight." | ~2K | 840 | 855 | 157 | **DAY 4 (2026-09-12 10:08), curve only now flattening — supersedes the day-1 row below.** 94,171 views / 69,816 viewers, 27 comments, 68 reposts, average watch still **20 s on 32 s (62.5%)** unchanged across four readings while reach grew 64x from the first. **Between day 1 and day 4 reach grew 2.12x and shares grew 2.77x — share rate 0.921% → 1.203%, RISING as it spread**, which inverts the usual dilution (its own views-per-viewer did dilute, 1.423 → 1.349). Saves 1.225%, likes ~2.8–2.9% (Instagram rounds to "2K"), follows 0.225%. **157 follows against 3 from every other reel r001–r010 combined.** The GATE 3 benchmark is revised up from 0.92% to **1.203% sends per reach**. Day-1 figures for reference: 46,782 views / 32,882 viewers, 916 likes, 303 shares, 362 saves, 71 follows, skip 29.9%, audience 99.9% non-followers, 58% India, 67% aged 25–44. **Three early conclusions were retracted** (saves at 1 h, shares at 4 h, skip rate at 7 h) — see `brand_guide_software.md` §13; the day-1 rates were a floor, and every one of them has since gone up. |
| `r006` | 2026-09-09 | A (below) — confirm which caption went out | "Your message to America doesn't go up to a satellite. It goes into the sea." | — | — | — | — | **~2.1k views at 2026-09-11** (read ~1.8k on 2026-09-09). The pre-registered test of the r005 pattern, failed — see `brand_guide_software.md` §13 "FALSIFIED". |
...
| `r011` | 2026-09-12 | **A (below) — confirmed, written in repo BEFORE posting** (`projects/r011_boarding/NOTES.md`) | "Back to front is slower than no system at all." | 15 | 1 | 3 | 1 | **FIRST READING, ~6 h: 2,913 views / 2,422 viewers, 15s avg watch (33.3% of 45s), skip rate 37.3% "Lower" (the hook worked). Sends 0.041% (1 share) — below r010's 0.124%, 29x below r005's 1.203%, inside the <0.2% band the PRE-REGISTERED reading named as falsifying.** This reel scored 3 of 3 named GATE 3 channels — the best score any reel has carried into a build — and it is the cleanest test the send test has ever had. **It failed: a full score is not sufficient.** Five prior GATE 3 answers (r006-r009) were all correct predictions of a MISSING channel; this is the first test of the opposite claim. Likely missing variable: HEAT, not structure — flat earth is identity-loaded, boarding order is only annoyance-loaded. **Saves and shares diverged**: save rate "Higher" (practical utility partly worked), share rate "Lower" (argument ammunition did not) — a single "sends" number would have hidden this split. Average watch 33.3% is above the 25% floor that would indict runtime, so length is not the explanation. See `brand_guide_software.md` §13 "THE RESULT IS IN: GATE 3 IS NECESSARY, NOT SUFFICIENT" and `projects/r011_boarding/NOTES.md`. |
