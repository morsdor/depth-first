...
export const RemotionRoot: React.FC = () => {
  return (
    <>
      ...
      {/* r013 · I81 · you don't sweat fat off, you breathe it out — NOT YET
          POSTED, in gate. The average human triglyceride, C55H104O6, grown as
          a real ball-and-stick molecule from tetrahedral/trigonal bond-angle
          constraints (projects/r013_breath/breath.py), not an authored
          diagram. Independently re-derives 84.25% of the fat's own mass
          leaving as CO2 and 15.75% as H2O against Meerman & Brown's published
          84% / 16% (BMJ 2014;349:g7257). One continuous @remotion/three
          camera push from the wide human scene into the molecule and back.
          Data from remotion/src/reels/data/breath.ts, which emit_ts.py
          refuses to write unless all 22 on-screen claims hold. */}
      <Composition
        id="r013-breath"
        component={Breath}
