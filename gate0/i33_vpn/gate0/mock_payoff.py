...
Nothing here is drawn from imagination:
  ...
  * coastline  — the GSHHG polylines r005 already shipped, read straight back
                 out of remotion/src/reels/data/r005_geo.ts. Same licence path,
...
GEO = Path('remotion/src/reels/data/r005_geo.ts')
...
def coastlines():
    """r005's GSHHG polylines, un-shifted back to real [-180, 180] longitude."""
