...
Proposed as **I15**. New permanent id, added to `content_backlog.md` §3 on 2026-09-10 — the
...
themselves. That is the question r006 could not answer, and it is why this id was picked.
...
**My assessment: the frame passes, the mechanism is thinner than r005's.** A stranger can name
...
4. **Licence check on any audio or model used** — the Gate 0 step added after r006. Our own
...
Yes → build as I15. No → it fails on kill condition 3; pick a different id, don't repair it.
